...
export default function Home() {
  ...
  return (
    ...
    <React.Fragment>
      <h1 className='subsclife-title'>subsclife</h1>
      <h1 className="Home-subscriptionList">一覧表示</h3>
      ...
      <Modal isOpen={mypageIsOpen} style={modalStyle}>
        <h1 className='mypage_user_name'>use name</h1>
        <div>
      ...
      <Modal isOpen={addmodalIsOpen} style={modalStyle}>
        <h1 className='addmodal_title'>add subscription</h1>
        <button className='close_add_modal' onClick={() => addmodalSetOpen(false)}>home</button>
      ...
      <Modal isOpen={removemodalIsOpen} style={modalStyle}>
        <h1 className='removemodal_title'>remove subscription</h1>
        <button className='close_removemodal' onClick={() => removemodalSetOpen(false)}>home</button>
      </Modal>
